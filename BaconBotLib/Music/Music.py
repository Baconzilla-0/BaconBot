    ...
    class Player:
        ...
        async def SongEnded(self):
            ...
            if self.Repeat: # track loop
                ...
                await self.LoadSong(self.Song.Meta.url, self.Song.IsFile)
        ...
        async def NowPlaying(self, Response: Types.CommandResponse):
            ...
            class NowPlayingView(discord.ui.View):
                ...
                async def UpdateMessage(BotMessage: Types.CommandResponse):
                    ...
                    await Response.Edit(Embed=Embed, View=NowPlayingView())
                ...
                async def Search_Callback(ButtonSelf, Button: discord.Button, Interaction: discord.Interaction):
                    ...
                    Input = self.Parent.Bot.Input(Channel, Interaction.user, "What do you want to search for?", Input_Callback)
        ...
        async def GetFiles(self, Response: Types.CommandResponse):
            Files = os.walk("./Temp")

            Number = 0
            List = []

            for Root, Directories, Names in Files:
                for File in Names:
                    Number += 1
            ...
            Pages = Pagination.PagedEmbed("Downloaded Files", 10, List)
            await Pages.Display(Response)
